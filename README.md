...
| `latex/10-titlepages` | meta | frontmatter multilinea (`extratitle`, `dedication`, `uppertitleback`, `lowertitleback`, `colophon`) → LaTeX para las páginas de título internas y el colofón final |
