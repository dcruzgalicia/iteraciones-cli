...
/**
 * Transpiler de formato HTML: transforma Divs con clase .center a
 * <div class="center"> con los bloques internos nativos.
 *
 * Para sobrescribir en un proyecto, crear un archivo con el mismo
 * nombre en <proyecto>/transpilers/html/03-center.ts.
 */
...
export async function transform(ast: Record<string, unknown>): Promise<Record<string, unknown>> {
  ...
  for (const block of blocks) {
    if (
      ...
      newBlocks.push({ t: 'RawBlock', c: ['html', '<div class="center">'] });
