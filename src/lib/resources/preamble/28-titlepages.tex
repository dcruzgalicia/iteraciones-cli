...
\newcommand{\colophonpage}{%
  ...
  \titlepageblock
    ...
    {\@colophon}%
  % publishers-image definido: el logo del editor cierra el colofón
  % (máx. 25% del textwidth).
  \ifx\@publishersimage\@empty\else
    \vskip 1\baselineskip
    {\centering\titleimagerender[0.25\textwidth]{\@publishersimage}\par}%
  \fi
}
\makeatother
