...
\newcommand{\colophonpage}{%
  ...
  % title-image definido: la imagen de portada también abre el colofón
  % (máx. 50% del textwidth).
  \ifx\@titleimage\@empty\else
    {\centering\titleimagerender[0.5\textwidth]{\@titleimage}\par}%
  ...
  \titlepageblock
    ...
    {\@colophon}%
  % publisher-image definido: el logo del editor cierra el colofón
  % (máx. 25% del textwidth). Soporta múltiples imágenes.
  \ifx\@publishersimagelist\@empty\else
    \vskip 1\baselineskip
    {\centering\expandafter\@renderpublishersimages@small\@publishersimagelist,\@nil\par}%
  \fi
}
\makeatother
