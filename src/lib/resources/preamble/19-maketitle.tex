...
\newcommand*{\@publishersimage}{}%
\newcommand{\publishersimage}[1]{\gdef\@publishersimage{%
    #1%
}}%
...
\renewcommand{\maketitle}{%
  ...
  \fi
  \ifx\@publishersimage\@empty
    \ifx\@publishers\@empty\else
      \vskip 1\baselineskip
      {\centering\parindent\z@\@publishers\par}%
    \fi
  \else
    % publishers-image definido: la imagen sustituye al texto de publishers
    % (máx. 40% del textwidth, ajustable).
    \vskip 1\baselineskip
    {\centering\titleimagerender[0.4\textwidth]{\@publishersimage}\par}%
  \fi
  \if@twoside
    \@tempswatrue
