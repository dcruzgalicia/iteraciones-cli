...
\def\@renderpublishersimages#1,{%
  \ifx\@nil#1%
    \let\next\relax
  \else
    \titleimagerender[150pt]{#1}%
    \let\next\@renderpublishersimages
  \fi
  \next
}%
\def\@renderpublishersimages@small#1,{%
  \ifx\@nil#1%
    \let\next\relax
  \else
    \titleimagerender[0.25\textwidth]{#1}%
    \let\next\@renderpublishersimages@small
  \fi
  \next
}%
...
\renewcommand{\maketitle}{%
  ...
  \else
    ...
    \vskip 2\baselineskip
    {\centering\expandafter\@renderpublishersimages\@publishersimagelist,\@nil\par}%
  \fi
  \if@twoside
    \@tempswatrue
