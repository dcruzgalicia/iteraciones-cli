...
%   guarda del endpaper (pág 1, solo si endpapers) → courtesy page (solo si
%   courtepage) → extratitle (pág impar, bloque del 75% del ancho centrado
...
%   twoside, bloque del 50% del ancho alineado a la derecha como el dictum,
%   con \vspace*{7\baselineskip} antes) → blank verso (solo twoside+openright,
%   el contenido siguiente empieza en página impar).
...
% endpaper, courtesy page): emite el recto y, solo en twoside+openright,
...
\renewcommand{\maketitle}{%
  % 1. Guarda del endpaper (pág 1) + verso en blanco si twoside+openright:
  % solo cuando endpapers está definido. \titlepageguards activa el dibujo
  % de la imagen en 30-endpapers.tex sobre la página 1.
  \ifx\@endpapers\@empty\else
    \titlepageguardstrue
    \titlepage@blankpage
  \fi
  ...
  \ifcourtepage
    \titlepage@blankpage
  \fi
  % 3. Extratitle (pág 1, bloque del 75% del ancho centrado con
  ...
  \fi
  % Dedication (página impar en twoside, bloque del 50% del ancho
  % alineado a la derecha como el dictum, con \vspace*{7\baselineskip} antes).
