...
\renewcommand{\maketitle}{%
  ...
  \ifx\@author\@empty\else
    {\centering\parindent\z@\usekomafont{author}{\renewcommand{\and}{\unskip, \ignorespaces}\@author\par}}%
    \ifx\interventionflag\@empty\else
      \ifx\@date\@empty\else
  ...
  \ifx\@titleimage\@empty
    ...
    \else
      {\centering\parindent\z@\usekomafont{title}{\@title\par}}%
    \fi
  \else
