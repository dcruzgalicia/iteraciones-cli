...
\newcommand{\titlepageblanks}{%
  \titlepageguardstrue
  \null\clearpage
  % twoside+openright+courtesyPage: segunda página en blanco para que
  % extratitle caiga en página impar. Sin courtesyPage: solo 1 página.
  \if@twoside\if@openright\ifcourtepage
    \null\clearpage
  \fi\fi\fi
}
