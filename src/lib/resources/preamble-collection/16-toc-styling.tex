...
\BeforeTOCHead{\RedeclareSectionCommand[beforeskip=4\baselineskip,afterskip=\baselineskip,afterindent=false]{chapter}}
\renewcaptionname{\languagename}{\contentsname}{\normalsize\normalfont\bfseries\MakeUppercase{Índice}}
\renewcommand*{\addparttocentry}[2]{%
  \addtocentrydefault{part}{#1}{\MakeUppercase{#2}}%
}
\DeclareTOCStyleEntry[pagenumberformat=\normalsize\normalfont,entryformat=\normalsize\normalfont,indent=0pt,linefill=\TOCLineLeaderFill,beforeskip=2\baselineskip]{tocline}{part}
