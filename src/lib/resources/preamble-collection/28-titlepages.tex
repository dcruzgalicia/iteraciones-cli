...
% pipeline. collectionCreator: command propio para collections que se
% comporta como \author.
%
...
\newcommand{\collectionCreator}[1]{\gdef\@collectionCreator{%
    #1%
}}%
\newcommand*{\@collectionCreator}{}%
\newcommand{\collectionCreatorPrefix}[1]{\gdef\@collectionCreatorPrefix{%
    #1%
}}%
\newcommand*{\@collectionCreatorPrefix}{}%
\makeatother

% Formato del contenido de las páginas internas: normalsize y sin
% indentación en ningún párrafo. El interlineado es el global (1.5).
