 ...
 * Tailwind 4.3.x (11 shades). Se inyecta como @theme en el CSS de entrada
 * (build-assets.ts): las utilities accent-* se generan con estos valores
 * directos, sin overrides. Fuente única de la lista de acentos validados
 * por config: añadir un color nuevo = añadir sus 11 shades aquí.
 */
