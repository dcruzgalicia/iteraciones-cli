...
El proyecto tiene pipeline completo, caché incremental, sistema de plugins, livereload, CLI completa, exportación PDF/EPUB via LaTeX, test suite y documentación. Las Fases 0–4 del roadmap original están completas.
...
**Las condiciones de v1.0 y las Fases 0–4 están completamente resueltas (mayo 2026).**

Para seguir madurando hacia v2.0+:
- Hooks adicionales en el sistema de plugins (`beforeBuild`, `onDocumentDiscovered`)
- Soporte de citas bibliográficas CSL en exportación (Fase 6)
...
#### 5.2 — Plugins con capacidad de generar archivos
...
### Fase 6 — Publicación multiplataforma (6-10 semanas)
...
#### 6.2 — Soporte de citas bibliográficas (CSL)
...
#### 6.4 — Control de exportación en watch mode
...
#### 6.5 — Soporte de math (LaTeX/MathML)
...
```
C1 → C3 → C4 → C5 → C8 → C9  (bugs y limpieza: 1-2 días)
